...
bot.command("uat", function (msg, reply, next) {
  var args = msg.args();
  if (msg.context.command) {
  ...
  msg.context.command = new Command(reply, msg.context, 'ssh server@root.test.com '+ args);
  msg.context.command.on("exit", function() {
    msg.context.command = null;
  });
});

bot.command("testqa", function (msg, reply, next) {
  var args = msg.args();
  if (msg.context.command) {
    var command = msg.context.command;
    return reply.text("A command is already running.");
  ...
  console.log("Chat «%s»: running command «%s»", msg.chat.name, args);
  msg.context.command = new Command(reply, msg.context, 'qapull '+ args);
  msg.context.command.on("exit", function() {
    msg.context.command = null;
  });
});
...
bot.command("test", function (msg, reply, next) {
  ...
  console.log("Chat «%s»: running command «%s»", msg.chat.name, args);
  msg.context.command = new Command(reply, msg.context, 'testpull '+ args);
  msg.context.command.on("exit", function() {
    msg.context.command = null;
  });
});

bot.command("testsupport", function (msg, reply, next) {
  var args = msg.args();
  if (msg.context.command) {
    var command = msg.context.command;
    return reply.text("A command is already running.");
  ...
  console.log("Chat «%s»: running command «%s»", msg.chat.name, args);
  msg.context.command = new Command(reply, msg.context, '/home/user/osticket.sh '+ args);
  msg.context.command.on("exit", function() {
    msg.context.command = null;
  });
});

bot.command("qasupport", function (msg, reply, next) {
  var args = msg.args();
  if (msg.context.command) {
    var command = msg.context.command;
    return reply.text("A command is already running.");
  ...
  console.log("Chat «%s»: running command «%s»", msg.chat.name, args);
  msg.context.command = new Command(reply, msg.context, '/home/user/osticketqa.sh '+ args);
  msg.context.command.on("exit", function() {
    msg.context.command = null;
  });
});
...
bot.command("p", "type", function (msg, reply, next) {
  var args = msg.args();
  if (!msg.context.command)
    return reply.html("No command is running.");
